...
public class SimpleOpenChinesePostmanProblem {
    ...
    public static void main(final String[] args) throws InterruptedException {
        ...
        final OpenCPP<MazeNode> closedCPP = OpenCPP.from(maze);
        final Solution<MazeNode> solution = closedCPP.solveFrom(maze.getNode(pocManPosition));
