...
public final class Routing1<T> implements RoutingInterface<T> {
    ...
    public static <T> Routing1<T> from(final UndirectedGraph<T> graph) {
        return new Routing1<T>(graph);
    }

    private Routing1(final UndirectedGraph<T> graph) {
        this.graph = graph;
    }
    ...
    public static void main(final String[] args) {
        ...
        final Routing1<MazeNode> feature = graph.getFeature(Feature.ROUTING);
        //feature.getData();
