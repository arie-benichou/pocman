...
public final class SmallerWeightedMatch {
    ...
    public SmallerWeightedMatch(final int[][] costs) {
        this.costs = costs;
    }
    ...
    private void input(final int[][] costs) {
        ...
        for (int i = 0; i < allocationSize; i++)
            this.adjacency[i] = this.end[i] = this.weight[i] = 0;
    }
    ...
    private SmallerWeightedMatch pointer(final int u, final int v, final int e) {
        int i, del;
    ...
    private SmallerWeightedMatch unpair(final int oldBase, final int oldMate) {
        int e, newbase, u;
        this.unlink(oldBase);
